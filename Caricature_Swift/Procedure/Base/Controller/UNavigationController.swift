//
//  UNavigationControllerViewController.swift
//  Caricature_Swift
//
//  Created by 姚智豪 on 2019/8/30.
...
class UNavigationController: UINavigationController {
    ...
    override func viewDidLoad() {
        ...
        //在 UIView 上添加返回上一级操作界面
        //https://blog.csdn.net/M316625387/article/details/82966080
        //KVC
...
extension UNavigationController: UIGestureRecognizerDelegate {
    ...
    func gestureRecognizerShouldBegin(_ gestureRecognizer: UIGestureRecognizer) -> Bool {
        let isLeftToRight = UIApplication.shared.userInterfaceLayoutDirection == .leftToRight //返回boolean
